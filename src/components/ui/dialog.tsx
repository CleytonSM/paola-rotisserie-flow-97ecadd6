...
// Store scroll position globally to persist across dialog lifecycle
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        onCloseAutoFocus={(e) => {
          // Prevent default focus behavior that might cause scroll
          e.preventDefault();
        ...
        onPointerDownOutside={(e) => {
          // Prevent pointer events from closing dialog and scrolling background
          e.preventDefault();
        }}
        onInteractOutside={(e) => {
          // Allow closing but prevent scroll interference
